                ...
                <div class=" col-sm-15 col-sm-offset-0">
                    ...
                    <form action="save.php" method="post">
                        <table class="table  table-bordered">
                            ...
                            <tbody>
                                <?php
                                $select_stmt = $conn->prepare("SELECT s.*, q.question FROM form_question as q INNER JOIN score as s on s.id_question =  q.id_queustion WHERE s.id_student = $id ");
                                $select_stmt->execute();
                                ...
                                ?>
                                    ...
                                    <TR class='normaldetail'>
                                        ...
                                        <TD bgcolor=#F0F7F7>มีความสามารถในการรับ-ส่งสาร <?= $ac['id_queustion'];?> </TD><input type="hidden" name="D02" required value="101" />
